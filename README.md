...
「ひとさじ」は、気になるレシピと作った日の記録を自分の端末に保存する、個人向けのレシピ管理PWAです。

- Web上のレシピURLや紙のレシピを保存
- 名前・材料・メモ・出典から検索
- 「作りたい」「お気に入り」で整理
- 日付・写真・感想を調理記録として追加
...
外部レシピの本文・動画・画像は取り込みません。作り方は元サイトを開いて確認します。レシピ、写真、調理記録はブラウザのIndexedDBに保存され、サーバーへの送信や自動同期は行いません。
